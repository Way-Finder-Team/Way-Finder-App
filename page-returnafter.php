<?php get_header(); ?>
        ...
        <div class="returnAftertop">
            ...
            <p id="returnAfterText">Located inside the foyer on the outside of the library next to the door, the designated Drop-Box can be used to return borrowed material when the library is closed. It can be found on the outside of the library.<br></P>
