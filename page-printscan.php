<?php get_header(); ?>
        ...
        <div class="printtop">
            ...
            <p>The library provides access to printers that students can use to print, photocopy and scan documents. 
           <br><br> Prices are displayed behind the multi function devices (MFDs). 
